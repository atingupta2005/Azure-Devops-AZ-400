...
1.  Open **Artifacts**, Cick **+ Create feed**
...
1.  In the **Name** textbox, type **PartsUnlimitedShared**, in the **Scope** section, select the **Organization** option, Click **Create**.
1.  Click **Connect to feed**.
1.  In the **NuGet** section, select **Visual Studio** and, copy the **Source** url
...
1.  In the **Options** dialog box, click **Package Sources** and click the plus sign
1.  In **Name** textbox, replace **Package source** with **PartsUnlimitedShared** and, in the **Source** textbox, paste the URL you copied in the Azure DevOps portal
1.  Click **Update** and then click **OK**
...
1.  Delete **Class1.cs**
1.  Right-click the **PartsUnlimited.Shared** project node and select **Properties**.
1.  Verify that the **Target framework** is set to **.NET Framework 4.5.1**.
...
1.  Click **Get the tools**.
1.  Click the **Download the latest NuGet** link
1.  Select nuget.exe version **v5.5.1** and download the executable
1.  Switch to the **Visual Studio** window. Right-click the **PartsUnlimited.Shared** project node and, select **Open Folder in File Explorer**.
1.  Move the downloaded **nuget.exe** file from the **Downloads** folder into the folder containing the **.csproj** file.
...
1.  Switch to the **Administrator: Windows PowerShell** window and run the following to publish the package to the **PartsUnlimitedShared** feed:
    ...
    ```
1.  Switch to the web browser window displaying the Azure DevOps portal and, Open **Artifacts**.
1.  Click the dropdown list in the upper left corner and, in the list of feeds, select the **PartsUnlimitedShared** entry
...
1.  Switch to the **Visual Studio**
1.  In the **Solution Explorer** pane, right-click the **References** node under the **PartsUnlimitedWebsite** project and, in the right-click menu, select **Manage NuGet Packages**
1.  Click the **Browse** tab and, in the **Package source** drop-down list in the upper right corner of the pane, select **PartsUnlimitedShared**.
...
1.  Switch to the **Visual Studio** window and open **PartsUnlimited.Shared** project
1.  Right-click the **PartsUnlimited.Shared** project node, in the right-click menu, select **Add** and, in the cascading menu, select **New Item**.
